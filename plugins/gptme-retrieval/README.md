...
This plugin adds a STEP_PRE hook that automatically retrieves relevant context before each LLM step, using backends like [qmd](https://github.com/tobi/qmd) for semantic and keyword search.
...
backend = "qmd"          # Backend: "qmd", "grep", or custom command
...
Uses [qmd](https://github.com/tobi/qmd) for retrieval. Supports three modes:
