...
def _load_project_instructions(workspace: str | None = None) -> str:
    ...
    preamble = (
        ...
        "use workspace_search if that tool is available; otherwise use the subagent "
        "tool. Never guess. Recap / 'last hour' questions belong on workspace_search "
        "so they do not hit the subagent timeout.\n\n"
